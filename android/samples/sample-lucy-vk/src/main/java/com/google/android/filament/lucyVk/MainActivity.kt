...
package com.google.android.filament.lucy_vk
...
class MainActivity : Activity() {
    ...
    private fun setupScene() {
        ...
        mesh = loadMesh(assets, "models/lucy.filamesh", materials, engine)
    ...
    private fun setupMaterial() {
        ...
        baseColor = loadTexture(engine, resources, R.drawable.pirate_gold_color, TextureType.COLOR)
        normal = loadTexture(engine, resources, R.drawable.pirate_gold_normal, TextureType.NORMAL)
        ao = loadTexture(engine, resources, R.drawable.pirate_gold_ao, TextureType.DATA)
        roughness =
                loadTexture(engine, resources, R.drawable.pirate_gold_roughness, TextureType.DATA)
        metallic = loadTexture(engine, resources, R.drawable.pirate_gold_metallic, TextureType.DATA)
