...
package com.google.android.filament.pbr_sphere
...
class MainActivity : Activity() {
    ...
    private fun setupScene() {
        ...
        mesh = loadMesh(assets, "models/sphere.filamesh", materials, engine)
    ...
    private fun buildMaterial() {
        ...
        val matPackage =
                MaterialBuilder()
                        // By default, materials are generated only for DESKTOP. Since we're an
                        // Android
                        ...
                        // Add a parameter to the material that can be set via the setParameter
                        // method once
                        // we have a material instance.
                        .uniformParameter(MaterialBuilder.UniformType.FLOAT3, "baseColor")

                        // Fragment block- see the material readme (docs/Materials.md.html) for the
                        // full
                        // specification.
                        .material(
                        ...
                        // Turn off shader code optimization so this sample is compatible with the
                        // "lite"
                        // variant of the filamat library.
                        .optimization(MaterialBuilder.Optimization.NONE)

                        // When compiling more than one material variant, it is more efficient to
                        // pass an Engine
